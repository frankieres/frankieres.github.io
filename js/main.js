$(document).ready(()=>{
	...
	$('#footer').html(`
		<footer class="flex flex-wrap justify-center py-10-xxl py-5-sm">
			<div class="col-8-xxl col-9-lg col-10-md px-2-md px-3-sm flex flex-wrap-md ">
				...
				<div class="col-3-xxl col-10-sm">
					...
					<p class="m-0 py-2"><i class="icon-email"></i> &nbsp;frankieres0@gmail.com</p>
		...
		<div id="ex1" class="modal">
		  <p class="m-0 text-md pb-1">whatsapp</p>
		  <p class="m-0">🇬🇧 +447960886147</p>

		  <p class="m-0 pt-3 text-md pb-1">email</p>
		  <p class="m-0">&nbsp;frankieres0@gmail.com</p>
